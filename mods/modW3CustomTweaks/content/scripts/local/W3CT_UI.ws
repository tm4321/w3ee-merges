...
function W3CT_UI_ToggleEnemyHealthbar(action : SInputAction) : void
{
    var flag : string;
...
function W3CT_UI_ToggleEnemyHealthbarOff(): void
{
    var bToggleOff : bool;
    var hud : CR4ScriptedHud;
    var inGameConfigWrapper : CInGameConfigWrapper;
    ...
    hud = (CR4ScriptedHud)theGame.GetHud();
    inGameConfigWrapper = (CInGameConfigWrapper)theGame.GetInGameConfigWrapper();
    bToggleOff = inGameConfigWrapper.GetVarValue('W3CT_UI', 'bToggleHealthbarOff') == "true";
